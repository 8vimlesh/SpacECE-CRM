...
export interface AutomationRule {
  ...
  name: string;
  description: string;
  triggerEvent: 'INQUIRY_CREATED' | 'INQUIRY_STAGE_CHANGED' | 'INQUIRY_FOLLOWUP_DUE' | 'CONTACT_CREATED' | 'CONTACT_OPTED_OUT' | 'WHATSAPP_INCOMING' | 'WHATSAPP_OUTGOING' | 'CAMPAIGN_CREATED' | 'CAMPAIGN_COMPLETED' | 'CAMPAIGN_FAILED';
